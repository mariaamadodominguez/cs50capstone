...
- Use of environment to avoid storing API keys in my source code. 
...
<ins>If the user is registered and has chosen one of the already saved locations, there are 3 additional buttons:</ins>  
    - **5 Days Forecast**  
